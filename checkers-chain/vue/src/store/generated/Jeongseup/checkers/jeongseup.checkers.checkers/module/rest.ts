...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/Jeongseup/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/Jeongseup/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/Jeongseup/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/Jeongseup/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/Jeongseup/checkers/checkers/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/Jeongseup/checkers/checkers/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/Jeongseup/checkers/checkers/system_info
   */
  querySystemInfo = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetSystemInfoResponse, RpcStatus>({
      path: `/Jeongseup/checkers/checkers/system_info`,
      method: "GET",
      format: "json",
      ...params,
    });
