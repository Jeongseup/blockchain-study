...
Blockchain.prototype.createNewBlock = function (nonce, previouseBlockHash, hash) {
    const newBlock = {
...
Blockchain.prototype.hashBlock = function (previouseBlockHash, currentBlockData, nonce) {
    const dataAsString = previouseBlockHash + nonce.toString() + JSON.stringify(currentBlockData);
